...
ad = convolution_ds.covering_grid(level=0, left_edge=[0.0, 0.0, 0.0], dims=ds.domain_dimensions)
...
pressure_subset_file.create_dataset('p_eff_x', data=p_eff_x.flatten()[subset])
pressure_subset_file.create_dataset('p_eff_y', data=p_eff_y.flatten()[subset])
pressure_subset_file.create_dataset('p_eff_z', data=p_eff_z.flatten()[subset])
pressure_subset_file.create_dataset('density', data=density.flatten()[subset])
