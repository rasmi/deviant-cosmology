...
for simtype in simtypes:
    params = [simtype,'b200','n1024','t0.005','h2','iso','z10_']
    ...
    for filename in filenames:
        ...
        elif filename is 'fluid_b200_n1024_t0.005_h2_z10.out': 
            kvalues, ps = np.loadtxt(result_dir+filename, unpack=True)
            ps = (ps - ps_base)/ps_base
...
plt.title('Relative Power Spectrum, Isothermal and Adiabatic Fluid Comparison z=10 200Mpc/h')
plt.legend(numpoints=1, loc='best')
plt.savefig('isothermal_fluid_low_adiabatic_normalized_particle_b200_z10.png')
